...
function processEnvironmentVariables() {
    var environmentVariables = [
             ...
             'LWM2M_MONGO_USERNAME',
             'LWM2M_MONGO_PASSWORD', 
             'LWM2M_MONGO_AUTH_DB',
             'LWM2M_AUTOCAST',
             'LWM2M_MONGO_RETRIES',
             'LWM2M_MONGO_RETRY_TIME'
        ],
        mongoVariables = [
             'LWM2M_PORT',
             'LWM2M_PROTOCOL',
    ...
    if (process.env.LWM2M_MONGO_USERNAME) {
        config.mongodb.username = process.env.LWM2M_MONGO_USERNAME;
    }
    
    if (process.env.LWM2M_MONGO_PASSWORD) {
        config.mongodb.password = process.env.LWM2M_MONGO_PASSWORD;
    }
    
    if (process.env.LWM2M_MONGO_AUTH_DB) {
        config.mongodb.authDB = process.env.LWM2M_MONGO_AUTH_DB;
    }
